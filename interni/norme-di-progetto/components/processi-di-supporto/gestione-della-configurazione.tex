...
\subparagraph{Versione di prodotto}%
...
\subsubparagraph{Eventuale aderenza ai principi delle twelve-factor app}%
...
\subsubparagraph{Identità di prodotto}%
...
\subparagraph{Struttura dei messaggi di commit}%
