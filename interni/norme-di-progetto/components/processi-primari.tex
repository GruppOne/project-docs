...
È un software open source che permette la costruzione di diagrammi UML a partire dalla scrittura di codice in un linguaggio di markup dedicato.
Ciò permette di versionare efficacemente i diagrammi generati.
...
Eseguendo mentre si è posizionati nella radice della documentazione di progetto il comando
...
% TODO descrivere utilizzo pgfgantt
