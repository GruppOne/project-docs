...
Il framework utilizzato per lo sviluppo backend è \glossarioLocale{Spring}, in particolare \textit{Spring Boot}, che è un framework concepito per la realizzazione di software enterprise su piattaforma Java.
