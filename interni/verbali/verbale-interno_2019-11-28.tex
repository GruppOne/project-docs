...
\begin{enumerate}
  \item Scelta prima suddivisione dei ruoli
  \item Scelto di separare la repo di documentazione da quella di codice
  \item Scelta struttura della repo di documentazione
  \item Scelto standard per i messaggi di commit
  \item Scelto standard per il numero di versione
\end{enumerate}
