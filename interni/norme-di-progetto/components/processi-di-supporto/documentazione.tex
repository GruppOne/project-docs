...
\paragraph{MPS-IDG: Indice di Gulpease}% in questo caso NON ci va il "\@". chktex 13
...
\end{itemize}
\paragraph{MPS-IGF: Indice di Gunning Fog}% in questo caso NON ci va il "\@". chktex 13
...
\paragraph{MPS-CO: Correttezza ortografica}% in questo caso NON ci va il "\@". chktex 13
