...
\fancyhf{}
\fancyhead[R]{\includegraphics[width=2cm]{../commons/img/logo-unipd.png}}
\fancyhead[L]{\includegraphics[width=2cm]{../commons/img/logo.png}}
...
% TODO finire di compilare lettera di presentazione
\{ \ldots \}
\begin{itemize}
  \item \{allegati\}
\end{itemize}
...
\begin{adjustwidth}{2.5cm}{10.5cm}
  ...
  % TODO scrivere nome del responsabile
  Nome Cognome\\
  \hspace{2cm}
