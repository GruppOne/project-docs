...
% FIXME sicuri che questa sezione sia corretta qui e non vada integrata con quella più in alto?
\placeholder{L'analisi dei requisiti è l'attività che studia e comprende il dominio applicativo del problema e ha come scopo quello di offrire i requisiti che dovranno essere soddisfatti dal software.}
...
% FIXME sicuri che questa sezione sia corretta qui e non vada integrata con quella più in alto?
\placeholder{L'attività di progettazione precede la codifica e si occupa di organizzare le componenti del sistema cercando una soluzione che possa soddisfare tutti gli stakeholders e che adempia alle necessità e ai bisogni definiti durante l'attività di analisi dei requisiti.}
