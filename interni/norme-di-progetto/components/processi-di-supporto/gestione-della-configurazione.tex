...
Utilizziamo il workflow Trunk Based Development (\href{https://trunkbaseddevelopment.com/}{https://trunkbaseddevelopment.com/}) a livello dei singoli repository sia per la documentazione di progetto che per le componenti software, considerando come \glossario{trunk} la branch di default \textit{master}.
