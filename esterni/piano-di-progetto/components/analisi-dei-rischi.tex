...
\begin{longtable}[H]{|p{10em}|p{13em}|p{13em}|p{10em}|}
  ...
  \hline % chktex 44
  Erronea implementazione delle funzionalità \textbf{RPRD001}&
  L'inesperienza dei membri del gruppo può portare ad una erronea o non completa implementazione di alcune funzionalità. &
  La fase di verifica e collaudo, se svolta nel modo corretto, ha lo scopo di trovare e correggere eventuali difetti nello sviluppo del prodotto.&
  \textbf{Probabilità:}   Alta \textbf{Impatto: }  Tollerabile  \\
  Monitoraggio:&
  \multicolumn{3}{p{38.5em}|}{Il responsabile monitorerà spesso lo stato del progetto per eventualmente riassegnare le risorse disponibili e limitare il ritardo.}\\
  \hline % chktex 44
  ...
  Monitoraggio:&
  \multicolumn{3}{p{38.5em}|}{Se possibile, il proponente notificherà il gruppo in caso di problemi. In ogni caso, la copia dell'applicazione sul server non sarà l'unica copia disponibile.}\\
  \hline % chktex 44
