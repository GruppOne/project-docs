...
\begin{description}
  ...
  \begin{description}
    \item [Dipendenza]: la dipendenza può verificarsi in due casi:
      ...
      \end{figure}
    \item [Assocazione]: l'associazione si verifica quando un oggetto di classe A ha un campo dati di tipo B.
    ...
    \begin{figure}[H]%
      ...
      \includegraphics[width=2.1cm]{ereditarietà.png}
      \centering
...
Hanno un'etichetta che identifica il nome, il quale deve essere in minuscolo e in inglese e possono contenere al loro interno altri sottopackage o classi.
Inoltre le dipendenze tra package si indicano con frecce tratteggiate e dovrebbero tutte seguire la medesima direzione.
 ...
 I diagrammi delle attività rappresentano l'insieme delle azioni che ne costituiscono il funzionamento. Un tipico diagramma delle attività in PlantUML è:
  \begin{figure}[H]%
    \label{fig:attività}
    \includegraphics[width=5cm]{attività.png}
    \centering
