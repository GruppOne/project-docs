...
\begin{document}
  ...
  Problemi Accademici[Rischio del personale] & La quasi totalità dei membri del gruppo porta avanti altre attività accademiche oltre a questo progetto e dunque possono sovrapporsi gli impegni dei vari memrbi. & é stato approvato sin dal primo periodo un calendario condiviso di impegni per cui era richiesta la partecipazione di tutti i componenti del gruppo. & \textbf{Probabilità: }    Alta \textbf{Impatto: }    Basso\\
