...
\cellcolor{white!80!lightgray!100} & Riccardo Agatea & 2020--04--12 & verifica documento completo \\%
\multirow{-3}{*}{\versione} \cellcolor{white!80!lightgray!100} & Alberto Gobbo & 2020--04--11 & aggiungi i nuovi termini al glossario e stendi la definizione \\
\cellcolor{lightgray} & Riccardo Agatea & 2020--03--02 & approva documento \\%
\cellcolor{lightgray} & Riccardo Agatea & 2020--03--01 & verifica documento completo \\%
\multirow{-3}{*}{0.1.3} \cellcolor{lightgray} & Alberto Gobbo & 2020--03--01 & aggiungi i nuovi termini al glossario e stendi la definizione \\
\cellcolor{white!80!lightgray!100} & Alessandro Rizzo & 2020--01--13 & approva documento \\%
\cellcolor{white!80!lightgray!100} & Riccardo Agatea & 2020--01--12 & verifica documento completo \\%
\cellcolor{white!80!lightgray!100} & Alberto Gobbo & 2020--01--10 & aggiungi i termini al glossario e stendi la definizione \\%
\multirow{-4}{*}{0.0.8} \cellcolor{white!80!lightgray!100} & Alberto Gobbo & 2020--01--10 & crea struttura documento latex vuoto %
}
...
\begin{description}
  ...
  \item[Aree d'interesse] \placeholder{scrivere o ignorare questa definizione}
...
\begin{description}
  ...
  \item[Javascript] \placeholder{scrivere o ignorare questa definizione}
\end{description}
\newpage
\section{K}
\begin{description}
...
\begin{description}
  ...
  \item[Modello server/client] \placeholder{scrivere o ignorare questa definizione}
\end{description}
\newpage
\section{N}
\begin{description}
...
\begin{description}
  ...
  \item[Utenti anonimi] \placeholder{scrivere o ignorare questa definizione}
  \item[Utenti autenticati] \placeholder{scrivere o ignorare questa definizione}
\end{description}
\newpage
\section{V}
\begin{description}
