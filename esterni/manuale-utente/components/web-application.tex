...
\begin{figure}[H]
    \centering
    \includegraphics[width=160mm]{organizations-list.jpg}
    \caption{Visualizza organizzazioni}%
    \label{fig:web_app_visualizza_organizzazioni}
\end{figure}

Una volta che l'utente si trova nella pagina relativa al suo profilo, ha la possibilità di visualizzare la propria lista delle organizzazioni attraverso l'apposito pulsante.\\
...
\begin{itemize}
    ...
    \item Un'icona che rappresenta il ruolo dell'utente in un'organizzazione: è possibile visualizzare testualmente il ruolo di un utente spostando il cursore sopra l'icona.
    \item Un'icona che rappresenta se l'organizzazione è di dominio pubblico o di dominio privato: è possibile visualizzare testualmente il dominio di un'organizzazione spostando il cursore sopra l'icona.
\end{itemize}

L'utente ha la possibilità di interagire con la pagina e può:
...
\begin{enumerate}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=120mm]{create-organization-1.jpg}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=120mm]{create-organization-2.jpg}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=120mm]{create-organization-3a.jpg}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=120mm]{create-organization-3b.jpg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=120mm]{create-organization-4.jpg}
