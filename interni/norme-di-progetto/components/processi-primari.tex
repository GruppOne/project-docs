...
La \glossario{Technology Baseline} è un documento tecnico parte integrante della RP.\@ Essa presenta:
...
La \glossario{Product Baseline} è un documento tecnico parte integrante della RQ.\@ Ha il compito di mostrare l'architettura del prodotto attraverso la creazione di:
