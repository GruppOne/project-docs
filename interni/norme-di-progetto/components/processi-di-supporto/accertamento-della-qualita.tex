...
\paragraph{Percentuale delle metriche soddisfatte (PMS)}%
\label{par:percentuale_delle_metriche_soddisfatte}

La metrica permette di conoscere la percentuale delle metriche soddisfatte rispetto a tutte le metriche disponibili.
...
dove:
\begin{description}
  \item[PMS] risultato che indica la percentuale di metriche soddisfatte.
