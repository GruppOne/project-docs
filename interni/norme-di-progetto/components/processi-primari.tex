...
Per i diagrammi di Gantt il gruppo ha scelto di utilizzare \glossario{pgfgantt}, un package disponibile per \latex{} che sfrutta il linguaggio \glossario{PGF} e il rispettivo omonimo interprete.
PGF è in grado di produrre rappresentazioni grafiche vettoriali, e pgfgantt fornisce dei comandi \tex{} che fungono da astrazioni per le direttive di basso livello.
