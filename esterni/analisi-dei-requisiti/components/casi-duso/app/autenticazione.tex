...
\begin{description}
  ...
  \item[Attori primari:] utente non autenticato;
  \item[Precondizione:] i dati forniti dall'utente non corrispondono a delle credenziali valide;
  \item[Postcondizione:] l'applicazione mobile comunica all'utente la mancata riuscita di autenticazione;
  \item[Scenario principale:]
        \begin{enumerate}
