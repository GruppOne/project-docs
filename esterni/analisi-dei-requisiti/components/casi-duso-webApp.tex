...
\begin{itemize}
  ...
  \item \textbf{Descrizione:} l'\glossario{utente non autenticato} tenta di autenticarsi al sistema;
...
\begin{itemize}
  \item \textbf{Attori primari:} \glossario{utente non autenticato};
  \item \textbf{Descrizione:} l'\glossario{utente non autenticato} visualizza la pagina di login, dove poter inserire le proprie credenziali.
...
\begin{itemize}
  \item \textbf{Attori primari:} \glossario{utente non autenticato};
  \item \textbf{Descrizione:} al fine di portare a termine il processo di login di un \glossario{utente}, esso deve inserire la propria e-mail, campo obbligatorio;
  \item \textbf{Scenario principale:} l'\glossario{utente non autenticato} compila il campo relativo alla sua e-mail di registrazione;
  \item \textbf{Precondizione:} il sistema ha reso disponibile il campo per l'inserimento della e-mail;
  \item \textbf{Postcondizione:} l'\glossario{utente non autenticato} ha compilato il campo relativo alla sua e-mail.
\end{itemize}
% subsub:UC1.1.1 (end)
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:} un \glossario{utente autenticato} vuole iniziare ad utilizzare \glossario{Stalker} creando una sua \glossario{organizzazione};
  \item \textbf{Precondizione:} l'\glossario{utente autenticato} non deve essere un \glossario{owner};
  \item \textbf{Postcondizione:} viene approvata la richiesta, e l'\glossario{utente autenticato} diventerà un \glossario{owner}.
