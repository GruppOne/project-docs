...
Attualmente \textit{Stalker} non è disponibile per il download tramite \textit{\glossario{Play Store}}, ma è disponibile solo tramite installazione manuale.
...
\begin{itemize}
    ...
    \item Scaricare l'\textit{\glossario{APK}} di \textit{Stalker} dall'apposito link dal browser del vostro smartphone.
...
% \begin{figure}[H]
%     \centering
%     \includegraphics{pagina-iniziale.png}
...
Se il problema è di natura tecnica, vi preghiamo di contattare il vostro \textit{\glossario{vendor}} al più presto.
