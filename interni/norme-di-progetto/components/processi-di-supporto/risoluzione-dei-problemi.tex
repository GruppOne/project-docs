...
\paragraph{Etichette delle issue}%
\label{par:etichette_delle_issue}
...
Aprendo il pannello \textit{label} dall'interfaccia di creazione di un issue è possibile scegliere le etichette che si ritengono più opportune. È possibile eseguire il medesimo procedimento anche per le \textit{Pull Request} sebbene non sia strettamente necessario.
Le etichette hanno lo scopo di esplicitare il contesto del problema, il tipo di issue aperta e la priorità da assegnare.
