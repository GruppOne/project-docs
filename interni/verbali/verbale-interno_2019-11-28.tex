...
\setModifiche{%
\cellcolor{white!80!lightgray!100} & Alessandro Rizzo & 2019--11--29 & approva documento \\%
\cellcolor{white!80!lightgray!100} & Tobia Apolloni, Riccardo Cestaro & 2019--11--29 & verifica verbale \\%
\multirow{-3}{*}{-} \cellcolor{white!80!lightgray!100} & Alberto Gobbo & 2019--11--28 & stendi verbale %
}
...
Abbiamo scelto di scrivere i messaggi di commit seguendo lo standard dato da conventional commits v1.0.0: \href{https://www.conventionalcommits.org/en/v1.0.0/}{https://www.conventionalcommits.org/en/v1.0.0/};
...
Abbiamo deciso di utilizzare il semantic versioning 2.0.0 (\href{https://semver.org/}{https://semver.org/}) per il versionamento, considerandone una versione modificata per il versionamento dei documenti.
...
\begin{description}
  \item[20191128-int-001] Scelta prima suddivisione dei ruoli
  \item[20191128-int-002] Scelto di separare la repo di documentazione da quella di codice
  \item[20191128-int-003] Scelta struttura della repo di documentazione
  \item[20191128-int-004] Scelto standard per i messaggi di commit
  \item[20191128-int-005] Scelto standard per il numero di versione
\end{description}
