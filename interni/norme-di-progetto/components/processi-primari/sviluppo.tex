...
\paragraph{MPR-CCE: Complessità ciclomatica eccessiva}% in questo caso NON ci va il "\@". chktex 13
...
\paragraph{MPR-CDU: Percentuale di duplicazione del codice}% in questo caso NON ci va il "\@". chktex 13
...
\paragraph{MPR-SML: Numero di code smell}% in questo caso NON ci va il "\@". chktex 13
...
\paragraph{MPR-BUG: Numero di bug rilevati}% in questo caso NON ci va il "\@". chktex 13
...
\paragraph{MPR-BGS: Tempo stimato di risoluzione bug}% in questo caso NON ci va il "\@". chktex 13
...
Sito web di PlantUML\@: \href{https://plantuml.com/}{https://plantuml.com/}.
% subp:plantuml (end)
...
Link alla documentazione del pacchetto: \href{http://texdoc.net/texmf-dist/doc/latex/pgfgantt/pgfgantt.pdf}{http://texdoc.net/texmf-dist/doc/latex/pgfgantt/pgfgantt.pdf}.
% subp:pgfgantt (end)
...
Link allo strumento: \href{https://www.nongnu.org/chktex/}{https://www.nongnu.org/chktex/}.
% subp:chktex (end)
...
Sito web di Visual Studio Code: \href{https://code.visualstudio.com/}{https://code.visualstudio.com/}.
% subp:vscode (end)
...
Documentazione di Stoplight: \href{https://stoplight.io/docs}{https://stoplight.io/docs}.
...
Sito web di IntelliJ IDEA\@: \href{https://www.jetbrains.com/idea/}{https://www.jetbrains.com/idea/}.
% subp:intellij (end)
...
Documentazione di SonarCloud: \href{https://sonarcloud.io/documentation}{https://sonarcloud.io/documentation}.
% subp:sonarcloud (end)
...
Link allo strumento: \href{https://checkstyle.sourceforge.io/}{https://checkstyle.sourceforge.io/}.
% subp:checkstyle (end)
...
Link allo strumento: \href{https://developer.android.com/studio/write/lint}{https://developer.android.com/studio/write/lint}.
...
Sito web di ESLint: \href{https://eslint.org/}{https://eslint.org/}.
% subp:eslint (end)
...
Sito web di Stylelint: \href{https://stylelint.io/}{https://stylelint.io/}.
% subp:stylelint (end)
...
Sito web di Prettier: \href{https://prettier.io/}{https://prettier.io/}.
% subp:stylelint (end)
...
Documentazione di Angular: \href{https://angular.io/docs}{https://angular.io/docs}.
...
Sito di Spring: \href{https://spring.io/}{https://spring.io/}.
...
Guida di Google allo sviluppo Android: \href{https://developer.android.com/guide}{https://developer.android.com/guide}.
...
Documentazione di Jasmine: \href{https://jasmine.github.io/}{https://jasmine.github.io/}.
...
Sito web di Protractor: \href{https://www.protractortest.org/}{https://www.protractortest.org/}.
...
Sito web di JUnit: \href{https://junit.org/junit4/}{https://junit.org/junit4/}.
...
Documentazione di Mockito: \href{https://site.mockito.org/}{https://site.mockito.org/}.
...
Documentazione di Espresso: \href{https://developer.android.com/training/testing/espresso}{https://developer.android.com/training/testing/espresso}.
...
Sito web di npm: \href{https://www.npmjs.com/}{https://www.npmjs.com/}.
...
Sito web di Gradle: \href{https://gradle.org/}{https://gradle.org/}.
\end{document}
