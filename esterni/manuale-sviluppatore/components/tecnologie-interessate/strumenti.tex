...
Lo strumento utilizzato per testare i comportamenti software previsti in un linguaggio logico che gli utenti possano comprendere, e quindi che supporta il Behaviour-Driven Development (\glossarioLocale{BDD}), è \glossarioLocale{Cucumber}.
