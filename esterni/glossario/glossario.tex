...
Riccardo Agatea & 2020--01--12 & verifica documento completo \\%
Alberto Gobbo & 2020--01--10 & aggiungi i termini al glossario e stendi la definizione \\%
Alberto Gobbo & 2020--01--10 & crea struttura documento latex vuoto \\%
}
...
\input{../../commons/template}
  ...
  \begin{description}
    ...
    \item[account] toDelele
    \item[amministratore] toDelete
    \item[analisti] toDelete
    \item[applicazione mobile] toDelete
    \item[architettura] toDelete
  ...
  \begin{description}
    ...
    \item[label] toDelete
    \item[linter] toDelete
    \item[luoghi] toDelete
    \item[luogo] toDelete
	\end{description}
  \section{M}
  \begin{description}
    ...
    \item[Modello a \textit{V] toDelete
    \item[milestone] toDelete
    \item[modello client/server] toDelete
  ...
  \begin{description}
    ...
    \item[Piano di progetto] toDelete
    \item[Piano di qualifica] toDelete
    \item[piano di qualifica] toDelete
    \item[postcondizioni] toDelete
    \item[precondizioni] toDelete
    \item[prodotto] toDelete
    \item[progetto] toDelete
    \item[Proof of concept] toDelete
    \item[proof of concept] toDelete
    \item[proponente] toDelete
    \item[prototipi] toDelete
    \item[Publisher/Subscriber] toDelete
	\end{description}
  \section{Q}
  \begin{description}
  ...
  \begin{description}
    ...
    \item[server LDAP] toDelete
    \item[sistema distribuito] toDelete
    \item[smartphone] toDelete
    \item[snippet] toDelete
    \item[software] toDelete
    \item[stakeholder] toDelete
    \item[statement] toDelete
    \item[stima] toDelele
    \item[subfiles] toDelete
	\end{description}
  \section{T}
  \begin{description}
    ...
    \item[tag] toDelete
    \item[test end-to-end] toDelete
    \item[ticket] toDelete
    \item[tracciatura] toDelete
	\end{description}
  \section{U}
  \begin{description}
