...
\begin{document}
La presente sezione ha lo scopo di descrivere in maniera dettagliata, attraverso il linguaggio \glossario{UML}, le funzionalitÃ¡ offerte da \glossario{Stalker}.
...
\begin{itemize}
  ...
  \item \textbf{\glossario{Utente collegato incognito}}: Si riferisce ad un \glossario{utente collegato} che ha deciso di rimanere in modalitÃ  incognito all'interno di un'organizzazione;
...
\begin{itemize}
  \item \textbf{\glossario{Utente non autenticato}}: si riferisce ad un \glossario{utente} che non ha ancora effettuato l'accesso alla webApp;
  \item \textbf{\glossario{Utente autenticato}}: si riferisce ad un \glossario{utente non autenticato} che ha affettuato l'accesso alla webApp;
  ...
  \item \textbf{\glossario{Owner}}: Si riferisce ad un \glossario{gestore} con privilegi di gestione utenti e organizzazione. Ã‰ il proprietario di un'organizzazione.
\end{itemize}
...
\subfile{components/casi-duso-webApp.tex}
% sub:casi_duso_webApp (end)
