...
Le indentazioni devono rispettare le seguenti sepcifiche:
\begin{itemize}
...
%Metrica ereditarietà da implementare
%MPS014 Classi che implementano classi concrete
%L’ereditarietà tra classi deve essere evitata perché la presenza di dipendenze tra più componenti
%ne ostacola la modifica e la verifica.
