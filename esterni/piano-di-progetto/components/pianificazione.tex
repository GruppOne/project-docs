...
\plchold{Registrazione, login, (setup root), root elimina account}
% sub:incremento_1 (end)
\subsection[Incremento 2]{Incremento 2 {\normalsize\normalfont\itshape(DD/MM/2020 \symbol{8594} DD/MM/2020)}}%
\label{sub:incremento_2}
\plchold{Creazione admin, richiesta ownering, gestione richieste (ownering)}
% sub:incremento_2 (end)
\subsection[Incremento 3]{Incremento 3 {\normalsize\normalfont\itshape(DD/MM/2020 \symbol{8594} DD/MM/2020)}}%
\label{sub:incremento_3}
\plchold{richiesta creazione organizzazione, gestione richieste (creazione organizzazione), root crea organizzazione, richiesta modifica organizzazione, gestione richieste (modifica organizzazione), root modifica organizzazione, root elimina organizzazione}
% sub:incremento_3 (end)
\subsection[Incremento 4]{Incremento 4 {\normalsize\normalfont\itshape(DD/MM/2020 \symbol{8594} DD/MM/2020)}}%
\label{sub:incremento_4}
\plchold{visualizza lista organizzazioni, collegamento a (lista) organizzazione/i, richiesta interrogazioni, richiesta dipendenti, anonimato}
% sub:incremento_4 (end)
\subsection[Incremento 5]{Incremento 5 {\normalsize\normalfont\itshape(DD/MM/2020 \symbol{8594} DD/MM/2020)}}%
\label{sub:incremento_5}
\plchold{richiesta creazione gestore, richiesta creazione visualizzatore}
% sub:incremento_5 (end)
\subsection[Incremento 6]{Incremento 6 {\normalsize\normalfont\itshape(DD/MM/2020 \symbol{8594} DD/MM/2020)}}%
\label{sub:incremento_6}
\plchold{richiesta gestione luogo, gestione richieste (creazione luogo), gestione richieste (modifica luogo), root gestione luoghi}
% sub:incremento_6 (end)
\subsection[Incremento 7]{Incremento 7 {\normalsize\normalfont\itshape(DD/MM/2020 \symbol{8594} DD/MM/2020)}}%
\label{sub:incremento_7}
\plchold{recupero credenziali, storico accessi utente, richiesta trasferimento proprietà, gestione richieste (trasferimento proprietà)}
