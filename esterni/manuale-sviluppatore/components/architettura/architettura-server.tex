...
\begin{itemize}
  ...
  \item Un database influxDB per gestire le timeseries.
\end{itemize}

\subparagraph{Database mySQL}
\label{subp:database_mySQL}
...
\subparagraph{Database InfluxDB}
\label{par:database_influxDB}
\end{document}
