...
\paragraph{\LaTeX}%
\label{par:LaTeX}
\LaTeX{} è il linguaggio di markup utilizzato da GruppOne per la stesura dei documenti. Si è preferito non utilizzare dei tool online come \href{https://www.overleaf.com/}{Overleaf}, dato che avevano dei vincoli di costo non sostenibili.
...
Esso misura il numero di errori ortografici presenti. Ogni componente del gruppo ha un estensione per il proprio code editor (e.g\@. per vscode consigliamo l'estensione \href{https://marketplace.visualstudio.com/items?itemName=ban.spellright}{Spell Right}, che si basa sul dizionario di sistema).
