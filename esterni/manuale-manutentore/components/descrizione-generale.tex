...
\begin{description}
  \item[Super utente:] è l'utente che detiene dei privilegi avanzati per l'uso della web application, diversi per ogni sottocategoria di super utente. In ordine decrescente di privilegi, i super utenti sono: administrator, owner, manager e viewer.
  \item[Utente generico:] è l'utente utilizzatore dell'applicazione mobile, ad esempio il dipendente di un'azienda che monitora la sua presenza, oppure un visitatore di un evento pubblico.
\end{description}
