...
\subfile{components/processi-organizzativi/gestione-dei-rischi}

% questo è il processo "management" nelle slide del professore
\subsection{Gestione di processo}%
\label{sub:gestione_di_processo}

\subfile{components/processi-organizzativi/gestione-di-processo}

\subsection{Formazione del personale}%
\label{sub:formazione_del_personale}

\subfile{components/processi-organizzativi/formazione-del-personale}
