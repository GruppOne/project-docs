...
\label{sub:appropriatezza_funzionale}
  ...
  \label{subs:metriche}
      \begin{description}
    \item [Completezza]: La completezza C del prodotto in relazione al numeri di requisiti soddisfatti verrà calcolata come \begin{equation} C = \frac{N_s}{N_{tot}}\\*100 \end{equation} con \(N_s\) numero di requisiti implementati e \(N_{tot}\) il numero di requisiti totali.
