...
Il proponente vincola il fornitore all'utilizzo del software \glossario{Sage Maker} e consiglia l'utilizzo della tecnologia di \glossario{Amazon Web Services}, in particolare i servizi:
\begin{description}
  \item[Elastic Container Service o Elastic \glossario{Kubernetes} Service] servizio di orchestrazione di contenitori altamente dimensionabile ad elevate prestazioni;
