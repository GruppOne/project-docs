...
Per realizzare, invece, il mapping delle classi Java in tabelle del database abbiamo utilizzato il driver \glossario{Hibernate} che è uno standard nel fornire servizi di \glossario{Object-Relational-Mapping}.
