...
La progettazione cerca, invece, di fissare l'\glossario{architettura} del prodotto scegliendo una soluzione che possa soddisfare tutti gli \glossario{stakeholders}.
...
La \glossario{Product Baseline} è un documento tecnico parte integrante della revisione di qualifica. Ha il compito di mostrare l'architettura del prodotto attraverso la creazione di diagrammi ``a grana fine'' (e.g. diagrammi delle classi o di package) e l'uso di \glossario{Design pattern}.
...
\begin{description}
  ...
  \item [Flessibilità]: al variare dei requisiti si deve essere in grado di apportare modifiche.
  \item [Riusabilità]: le sue parte possono essere reimpiegabili.
