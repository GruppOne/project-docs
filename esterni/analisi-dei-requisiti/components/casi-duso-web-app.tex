...
Di seguito sono riportati tutti i casi d'uso che coinvolgono il \glossario{super utente} amministratore.
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:}
  \begin{enumerate}
    \item \glossario{Root} inserisce l'e-mail dell'amministratore che vuole creare.
  \end{enumerate}
\end{itemize}
% subsub:AUC5.1.1 (end)
