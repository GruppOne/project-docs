...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:}
  \begin{enumerate}
    \item il \glossario{gestore} vuole effettuare richieste sui \glossario{luoghi} dell'\glossario{organizzazione} su cui opera;
  \end{enumerate}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:}
  \begin{enumerate}
    \item il \glossario{gestore} vuole aggiungere un nuovo \glossario{luogo} all'\glossario{organizzazione} su cui opera;
  \end{enumerate}
  \item \textbf{Inclusioni:}
  \begin{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:}
  \begin{enumerate}
    \item il \glossario{gestore} vuole eliminare un \glossario{luogo} all'\glossario{organizzazione} su cui opera;
  \end{enumerate}
\end{itemize}
% subsub:AUC10.2 (end)
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:}
  \begin{enumerate}
    \item il \glossario{gestore} vuole modificare un \glossario{luogo} dell'\glossario{organizzazione} su cui opera;
  \end{enumerate}
  \item \textbf{Inclusioni:}
  \begin{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:}
  \begin{enumerate}
    \item il \glossario{gestore} vuole modificare i parametri dell'\glossario{organizzazione} su cui opera;
  \end{enumerate}
  \item \textbf{Inclusioni:}
  \begin{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:}
  \begin{enumerate}
    \item l' \glossario{owner} vuole creare una nuova \glossario{organizzazione}.
  \end{enumerate}
  \item \textbf{Inclusioni:}
  \begin{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:} 
  \begin{enumerate}
    \item l' \glossario{owner} vuole cedere l'\glossario{organizzazione} ad un'altro \glossario{owner};
  \end{enumerate}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:} 
  \begin{enumerate}
    \item l' \glossario{owner} inserisce l'e-mail del nuovo owner;
  \end{enumerate}
\end{itemize}
% subsub:AUC12.1 (end)
% subsub:AUC12 (end)
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:} 
  \begin{enumerate}
    \item l' \glossario{owner} inserisce l'e-mail del nuovo visualizzatore;
  \end{enumerate}
\end{itemize}
% subsub:AUC13.1 (end)
% subsub:AUC13 (end)
...
\begin{itemize}
  ...
  \item \textbf{Scenario principale:} 
  \begin{enumerate}
    \item l' \glossario{owner} inserisce l'e-mail del nuovo gestore;
  \end{enumerate}
\end{itemize}
% subsub:AUC14.1 (end)
% subsub:AUC14 (end)
