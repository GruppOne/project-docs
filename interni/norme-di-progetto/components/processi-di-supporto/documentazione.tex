...
\begin{description}
  ...
  \item [Scrittura del documento] l'incaricato scrive il docu\imento incrementalmente e lo termina entro la scadenza della \glossario{milestone} fissata.
...
\begin{itemize}
  \item Analisi dei requisiti
        ...
        \textit{Destinatari}: tutti i componenti del team e committente.


  \item Studio di fattibilità

        \textit{Scopo}: valutare costi, pregi, difetti dei capitolati proposti.
...
\subsubparagraph{Stile del testo}%
...
\subsubparagraph{Convenzioni comuni}%
