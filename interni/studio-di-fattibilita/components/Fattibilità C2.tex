...
\begin{document}
	...
	\end{description}
	% subsubsection informazioni_generali (end)
...
Il programma deve offrire le seguenti funzionalità:
	...
	% subsubsection finalità_del_progetto (end)
	...
	\end{description}
	% subsubsection tecnologie_interessate (end)
	...
	\end{itemize}
	% subsubsection aspetti_positivi (end)
	...
	\end{itemize}
	% subsubsection criticità_e_fattori_di_rischio (end)
