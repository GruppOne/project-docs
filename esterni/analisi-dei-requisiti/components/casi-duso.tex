...
\begin{itemize}
  ...
  \item \textbf{\glossario{Owner}}: Si riferisce ad un \glossario{gestore} con privilegi di gestione utenti e organizzazione. É il proprietario di un'organizzazione.
\end{itemize}
