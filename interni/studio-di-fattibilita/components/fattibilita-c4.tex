...
\begin{document}
  ...
  \begin{description}
    ...
    \item [\glossario{Orange Canvas}]: è lo strumento di analisi dei dati consigliato dal proponente.
  \end{description}
