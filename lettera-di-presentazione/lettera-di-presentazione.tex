...
Tutti i dettagli relativi all'offerta che le proponiamo si possono trovare nei seguenti documenti riferiti alla versione \placeholder{versione}, presenti in allegato:
\begin{itemize}
...
\begin{adjustwidth}{2.5cm}{10.5cm}
  ...
  Alessandro Rizzo\
  \hspace{2cm}
  \underline{\color{white}{\includegraphics[width=2cm]{firme/alessandro_rizzo.png}}} % chktex 44
\end{adjustwidth}
