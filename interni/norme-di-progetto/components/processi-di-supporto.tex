...
Ognuno ha inoltre aggiunto un'estensione per il proprio Code Editor preferito (Sublime Text o Visual Studio Code) che consentisse di facilitare la corretta esecuzione del processo di build dei file *.tex.
