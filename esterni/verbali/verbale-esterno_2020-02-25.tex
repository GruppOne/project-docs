...
La prima correlazione ci permette di appurare che tutti i requisiti siano necessari perché derivano da un caso d'uso, la seconda che tutti i casi d'uso siano necessari perché si concretizzano in un requisito.
