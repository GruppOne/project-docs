...
\label{subs:documentazione/finalità}
...
\subsubsection{Finalità}%
\label{subs:gestione della configurazione/finalità}
...
\label{subs:accertamento della qualità}

\subsubsection{Finalità}%
\label{subs:accertamento della qualità/finalità}
...
\subsubsection{Descrizione}%
\label{subs:accertamento della qualità/descrizione}
...
\subsubsection{Finalità}%
\label{subs:validazione/finalità}
