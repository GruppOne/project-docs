...
\begin{description}
  \item [Versione] indica il numero di versione a cui una modifica è andata a contribuire tramite la sua approvazione. Ad ogni versione, infatti, corrisponde una catena di eventi che coinvolge scrittura, verifica e approvazione dei cambiamenti. Ogni approvazione di un documento (eccetto i verbali) produce uno scatto di versione. Una descrizione accurata del formato del numero di versione che GruppOne ha deciso di adottare è presente al paragrafo \ref{par:versione_di_prodotto}.
