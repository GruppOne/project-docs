...
\item Scenario principale: sorge la necessità di eliminare un'\glossario{organizzazione}, che per sconusciuti motivi non intende più utilizzare \glossario{Stalker}; 
\item Precondizione: deve essere stata selezionata l'\glossario{organizzazione} da eliminare, che deve essere presente nella lista di \glossario{Stalker};
