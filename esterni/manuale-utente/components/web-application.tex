...
Nel caso ci fossero problemi con il collegamento alla web application, consigliamo di consultare il sito \textbf{http://www.isitdownrightnow.com/},
per verificare e se il problema riguarda il vostro provider oppure il nostro server. \\
Nel caso in cui riguardi il nostro server vi preghiamo di riprovare l’accesso in un secondo momento.\\
