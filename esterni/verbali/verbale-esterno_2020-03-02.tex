...
\begin{enumerate}
  ...
  \item Personalmente conosco bene Spring Boot e Spring Data (molto più diffusi negli ambienti dove lavoro), sono un pò più carente per quanto riguarda Quarkus (che comunque mi sembra interessante come framework).
