...
\begin{itemize}
\item Attori primari: \glossario{gestore};
\item Descrizione: il \glossario{gestore} dell'\glossario{organizzazione} richiede di modificare i parametri di essa;
\item Scenario principale: il \glossario{gestore} vuole modificare i parametri dell'\glossario{organizzazione} su cui opera;
...
\begin{itemize}
\item Attori primari: \glossario{owner};
\item Descrizione: l' \glossario{owner} nomina un \glossario{visualizzatore} per la sua \glossario{organizzazione};
\item Scenario principale: l' \glossario{owner} vuole aggiungere un \glossario{visualizzatore} alla sua \glossario{organizzazione};
\item Precondizione: il nuovo \glossario{super utente} non deve già esistere come \glossario{visualizzatore};
\item Postcondizione: il nuovo \glossario{visualizzatore} è stato aggiunto.
...
\begin{itemize}
\item Attori primari: \glossario{owner};
\item Descrizione: l' \glossario{owner} nomina un \glossario{gestore} per la sua \glossario{organizzazione};
\item Scenario principale: l' \glossario{owner} vuole aggiungere un \glossario{gestore} alla sua \glossario{organizzazione};
\item Precondizione: il nuovo \glossario{super utente} non deve già esistere come \glossario{gestore};
\item Postcondizione: il nuovo \glossario{gestore} è stato aggiunto.
...
\begin{itemize}
\item Attori primari: \glossario{owner};
\item Descrizione: l' \glossario{owner} richiede di creare una nuova \glossario{organizzazione};
\item Scenario principale: l' \glossario{owner} vuole creare una nuova \glossario{organizzazione};
\item Precondizione: l' \glossario{organizzazione} non deve già esistere;
\item Postcondizione: la richiesta di creare una nuova \glossario{organizzazione} è stata posta.
...
\begin{itemize}
\item Attori primari: \glossario{owner};
\item Descrizione: l' \glossario{owner} richiede che l'\glossario{organizzazione} venga ceduta ad un altro futuro \glossario{owner};
\item Scenario principale: l' \glossario{owner} vuole cedere l'\glossario{organizzazione} ad un'altro \glossario{owner};
\item Precondizione: il futuro \glossario{owner} deve esistere;
\item Postcondizione: la richiesta di cedere l'\glossario{organizzazione} è stata posta.
